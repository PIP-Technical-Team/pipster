...
print(paste0("The poverty headcount is ", round(PG*100,2), "%"))
```
...
print((paste0("The poverty headcount is ", round(gap$pov_gap*100,2), "%")))
```

### 2.3 Poverty Severity

Finally, we utilize the `pipgd_pov_severity()` function to assess the poverty severity index. This index considers the squared poverty gap, placing more weight on the welfare of the poorest.
